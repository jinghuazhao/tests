...
\Address{
  ...
  Cambridge CB2 0QQ\\
  United Kingdom\\
  E-mail: \email{jinghuazhao@hotmail.com}\\
}
...
\begin{enumerate}
\item The hapmap project (\url{https://www.genome.gov/genetics-glossary/hapmap}), a
...
\url{https://www.wtccc.org.uk/}), a collaboration of human
...
(GAIN, \url{https://fnih.org/genetic-association-information-network-gain/}), a
...
500K and Illumina
(\url{https://www.illumina.com/}) 317K systems following an earlier
pilot using Perlegen platform with
about 250K SNPs. The samples were based on European Prospective
Investigation of Cancer (EPIC) Norfolk study
(\url{https://www.epic-norfolk.org.uk/}). Our particular concern is
...
\url{https://CRAN.R-project.org/}), taking advantages of the portable
...
(\url{https://www.bioconductor.org/}) package \pkg{RSNPper}
...
been launched and certainly an
