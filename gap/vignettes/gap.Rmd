...
vignette: >
  ...
  %\VignetteDepends{gap.datasets}
---

```{r setup, include=FALSE}
set.seed(0)
options(rmarkdown.html_vignette.check_title = FALSE, bitmapType = "cairo")
...
gk1 <- kin.morgan(as.matrix(lukas[1:3]))
...
gk2 <- kin.morgan(as.matrix(olukas[1:3]))
...
but in the second case, the result agrees with **kinship2**.
